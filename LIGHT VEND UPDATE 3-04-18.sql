...
insert  into `reportsclientorder`(`reportOrder_id`,`invoiceId`,`invoiceStatId`,`clientId`,`clientName`,`bustypeId`,`bustypeName`,`total_amount`,`amount_paid`,`handledBy`,`date_paid`) values (10,7,100001,7,'Halcyon Marine Healthcare Systems',1,'Computer',500,12000,'admin','2018-01-30'),(11,8,100002,7,'Halcyon Marine Healthcare Systems',2,'Industrial',7500,8000,'admin','2018-01-30'),(12,9,100005,7,'Halcyon Marine Healthcare Systems',2,'Industrial',11200,13000,'admin','2018-01-30'),(13,10,123,7,'Halcyon Marine Healthcare Systems',2,'Industrial',6720,6720,'admin','2018-03-02');
