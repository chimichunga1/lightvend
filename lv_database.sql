...
insert  into `clients`(`clientId`,`clientName`,`busTypeId`,`contactPerson`,`address`,`telno`,`mobileno`,`faxno`,`email`,`dateCreated`,`remarks`,`isActive`,`isDeleted`,`tin`,`osca_pwd_no`,`sc_tin_no`,`tax_status`) values (6,'asd1',1,'asd','asd','23123','','','','2017-12-13','',1,0,'','','','Non Vatable'),(7,'Halcyon Marine Healthcare Systems',2,'Glennda Canlas',NULL,'5117071',NULL,NULL,NULL,'2017-12-13',NULL,1,0,'1754541212',NULL,NULL,'Vatable');
...
insert  into `invoices`(`invoiceId`,`invoiceStatId`,`clientId`,`clientName`,`clientAddress`,`bustypeId`,`bustypeName`,`controlNo`,`tin`,`osca_pwd_no`,`sc_tin_no`,`date_created`,`due_date`,`terms`,`remarks`,`vatableSale`,`totalSales`,`vatExemptSale`,`lessVat`,`zeroRatedSale`,`discount`,`vat`,`sales`,`totalAmountDue`,`isDeleted`,`salesPerson`) values (1,12,6,'',NULL,1,NULL,NULL,NULL,NULL,NULL,'2018-01-07','2018-01-07',NULL,'14','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000',0,NULL),(2,13234,7,NULL,NULL,2,NULL,NULL,NULL,NULL,NULL,'2018-01-08','2018-01-08',NULL,'12','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000','0.0000',0,NULL);
...
insert  into `items_ordered`(`orderId`,`assetsId`,`assetName`,`quantity`,`unitPrice`,`sellPrice`,`invoiceId`,`handledBy`,`date-added`,`isDeleted`) values (20,2,'ASSET2',13,2000,3000,4,NULL,NULL,0),(21,1,'ASSET1',2,3000,4000,2,NULL,NULL,0),(22,1,'ASSET1',3,3000,4000,3,NULL,NULL,0),(23,2,'ASSET2',0,2000,3000,3,NULL,NULL,0),(24,2,'ASSET2',12,2000,3000,2,NULL,NULL,0),(25,2,'ASSET2',1,2000,3000,1,NULL,NULL,0),(26,1,'ASSET1',2,3000,4000,1,NULL,NULL,0);
...
insert  into `suppliers`(`supId`,`busTypeId`,`supName`,`contactPerson`,`address`,`telno`,`faxno`,`email`,`approved_by`,`date_approved`,`remarks`,`typeOfSup`,`isActive`,`isDeleted`) values (1,2,'Arnold','Ondevilla','mandaluyong city','09500516578','09500950590','float.sundae@gmail.com',0,'0000-00-00','','',0,0),(2,1,'Arnold3','Ondevillaa','Mandaluyong','123123','23123123','WEW@gmail.com',0,'0000-00-00','  ','Potential',0,0),(3,2,'arnoldawsdasd','0293123','asdaa','0903910231','123174915','float@gmail.com',0,'0000-00-00','','',0,0);
