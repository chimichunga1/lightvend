...
MySQL - 5.7.21-log : Database - lightvent
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`lightvent` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `accountabilitystatus`(`acctStatId`,`acctStatus`,`isDeleted`) values 
(1,'Preparation',0),
(2,'Send',0),
(3,'Settled',0),
(4,'Cancelled',0);
...
insert  into `assetgroup`(`assetGroupId`,`catId`,`groupName`,`description`,`sellPrice`,`date_created`,`isDeleted`,`unit`,`itemSold`,`itemOnStock`,`itemObselete`,`itemConsignment`,`maintaining`) values 
(1,1,'Desktop PC i3','',25000.0000,'2017-11-24 15:19:40',0,'unit',0,1,0,0,2);
...
(1,1,1,1,1,1,1,'1212','wewe','wqwq','wsws','wawa','121','2','0000-00-00','1212','0000-00-00','1212','1212',1222.0000,222.0000,'we','0000-00-00','22',12,12,'0000-00-00',11,1,0,2.0000);
...
insert  into `assetstwo`(`assetsId`,`code`,`serialName`,`supId`,`itmTypeId`,`assetName`,`brand`,`model`,`description`,`unitPrice`,`sellPrice`,`quantity`,`date_purchased`,`endofWarranty_date`,`req_date`,`remarks`,`isDeleted`,`asstId`,`entId`,`catId`,`statId`,`acqTypeId`,`delivery_date`,`deprec_value`,`pr_no`,`req_auth_id`,`req_dep_id`,`est_useful_life`,`isAccount`) values 
(1,'1111','1010',1,'d','ASSET1','brand1','model1','h','3000','4000',1,'l','m','n','o','0','q','r','s','t','u','v','w',NULL,NULL,NULL,NULL,NULL),
(2,'2222','129',2,'b','ASSET2','brand2','model2','m','2000','3000',1,'k','l','k','k','0','k','k','k','ll','l',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(3,'3333333','3918918',1,'2','Sample Item','Brand 123','Model 123','Maganda to pre ','200.00','500.00',115,'2018-01-23','2018-01-25',NULL,NULL,'0',NULL,NULL,NULL,NULL,NULL,'2018-01-26',NULL,NULL,NULL,NULL,NULL,NULL);
...
insert  into `businesstypes`(`busTypeId`,`busTypeName`,`isDeleted`) values 
(1,'Computer',0),
(2,'Industrial',0),
(3,'School',0),
(4,'asdasd',0),
...
insert  into `categories`(`catId`,`categoryName`,`isDeleted`) values 
(0,'',1),
(1,'Computers',0),
(2,'Network',0),
(3,'Audio/Video',0),
...
insert  into `clients`(`clientId`,`clientName`,`busTypeId`,`contactPerson`,`address`,`telno`,`mobileno`,`faxno`,`email`,`dateCreated`,`remarks`,`isActive`,`isDeleted`,`tin`,`osca_pwd_no`,`sc_tin_no`,`tax_status`) values 
(6,'asd1',1,'asd','asd','23123','','','','2017-12-13','',1,0,'','','','Non Vatable'),
(7,'Halcyon Marine Healthcare Systems',2,'Glennda Canlas',NULL,'5117071',NULL,NULL,NULL,'2017-12-13',NULL,1,0,'1754541212',NULL,NULL,'Vatable'),
(8,'Mountain Dew',1,'Mountain Man','Mandaluyong City','293039481','10293019','01039301','miguel_ccortez@yahoo.com.ph','2018-01-30','Remark1',0,0,'193819','0139100','9109189','Vatable');
...
insert  into `groups`(`groupid`,`groupName`,`isDeleted`) values 
(1,'test',0),
(2,'test123333',0);
...
insert  into `invoices`(`invoiceId`,`invoiceStatId`,`clientId`,`clientName`,`clientAddress`,`bustypeId`,`bustypeName`,`controlNo`,`tin`,`osca_pwd_no`,`sc_tin_no`,`date_created`,`due_date`,`terms`,`remarks`,`vatableSale`,`totalSales`,`vatExemptSale`,`lessVat`,`zeroRatedSale`,`discount`,`vat`,`sales`,`totalAmountDue`,`isDeleted`,`salesPerson`) values 
(7,100001,7,'Halcyon Marine Healthcare Systems',NULL,1,'Computer',NULL,NULL,NULL,NULL,'2018-01-30','2018-01-30',NULL,'Remarks here',0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,1,NULL);
...
insert  into `items_ordered`(`orderId`,`assetsId`,`assetName`,`quantity`,`unitPrice`,`sellPrice`,`invoiceId`,`handledBy`,`date-added`,`isDeleted`) values 
(29,3,'Sample Item',15,200,500,5,NULL,NULL,0),
(30,3,'Sample Item',20,200,500,5,NULL,NULL,0),
(31,2,'ASSET2',1,2000,3000,6,NULL,NULL,0),
(32,3,'Sample Item',10,200,500,7,NULL,NULL,0);
...
insert  into `reportsclientorder`(`reportOrder_id`,`invoiceId`,`invoiceStatId`,`clientId`,`clientName`,`bustypeId`,`bustypeName`,`total_amount`,`amount_paid`,`handledBy`,`date_paid`) values 
(10,7,100001,7,'Halcyon Marine Healthcare Systems',1,'Computer',500,12000,'admin','2018-01-30');
...
insert  into `status`(`statId`,`status`,`isDeleted`) values 
(0,'',0),
(1,'Sold',0),
(2,'Preparation',0),
(3,'Consignment',0),
...
insert  into `suppliers`(`supId`,`busTypeId`,`supName`,`contactPerson`,`address`,`telno`,`faxno`,`email`,`approved_by`,`date_approved`,`remarks`,`typeOfSup`,`isActive`,`isDeleted`) values 
(1,2,'Arnold','Ondevilla','mandaluyong city','09500516578','09500950590','float.sundae@gmail.com','0','0000-00-00','','',0,0),
(7,1,'Sample Supplier','Person 1','Makati City','3938193','210384891839','miguel_ccortez@yahoo.com','Master','2018-01-25','Remark','Potential',0,0);
...
insert  into `useraccount`(`user_id`,`user_name`,`user_password`,`accessright`,`isActive`) values 
(1,'admin','admin','1','1'),
(2,'user','user','2','1'),
(3,'test','test','1','1'),
(4,'ulit','ulit','1','1');
